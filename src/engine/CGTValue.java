...
public abstract class CGTValue {
	 ...
	 *
	 * @param other
	 *            The other CGTValue that shall be added
	 * @return The sum of the two CGTValues
	 * @throws IllegalAdditionException
	...
	public static CGTValue getOutcome(CGTValue leftValue, CGTValue rightValue) {
		...
		// "Not implemented for classes: left: " + (leftValue == null ? "null" :
		// leftValue.getClass()) + ", right: " + (
		...
		if (other == null) {
			...
			if (this instanceof Number) {
				...
				if (other instanceof Number) {
					...
					if(((Infinitesimal)this).getValue() <= ((Infinitesimal)other).getValue()) {
						return true;
					} else {
						return false;
					}
	...
	public boolean less(CGTValue other) {
		if(other == null) {
			...
			} else if(this instanceof Infinitesimal && other instanceof Infinitesimal) {
				if(((Infinitesimal)this).getValue() < ((Infinitesimal)other).getValue()) {
					return true;
				} else {
					return false;
