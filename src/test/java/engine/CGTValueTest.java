...
public class CGTValueTest {
    ...
    @Test public void combine_number_posNumber_Nimber() {
        CGTValue outcome = CGTValue.combine(new Number(3), new Nimber(2));
        Assert.assertThat(outcome, CoreMatchers.equalTo(new Number(3)));
    }

    @Test public void combine_number_zeroNumber_Nimber() {
    ...
    @Test public void combine_number_negNumber_Nimber() {
        CGTValue outcome = CGTValue.combine(new Number(-3), new Nimber(2));
        Assert.assertThat(outcome, CoreMatchers.equalTo(new Number(0)));
    }
     ...
     * -------------------------------------------------
     */
    @Test public void max_negNumber_Number() {
    ...
    @Test public void max_Number_negNumber() {
    ...
    @Test public void max_negNumber_negNumber() {
        CGTValue max = CGTValue.max(new Number(-2), new Number(-3), true);
        Assert.assertThat(max, CoreMatchers.equalTo(new Number(-2)));
    ...
    @Test public void max_Nimber_Number() {
        //Black
    ...
    @Test public void max_Number_Nimber() {
        //Black
    ...
    @Test public void max_negNumber_Switch() {
    ...
    @Test public void max_zeroNumber_Switch() {
        // Always prefer number? For both black and white??
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void max_Switch_negNumber() {
        // Always prefer number? For both black and white??
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void max_Switch_zeroNumber() {
        // Always prefer number? For both black and white??
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void max_negNumber_Infinitesimal() {
    ...
    @Test public void max_zeroNumber_Infinitesimal() {
    ...
    @Test public void max_Infinitesimal_negNumber() {
        CGTValue max = CGTValue.max(new Number(-3), new Infinitesimal(1), true);
        Assert.assertThat(max, CoreMatchers.equalTo(new Infinitesimal(1)));
    ...
    @Test public void max_Infinitesimal_zeroNumber() {
        CGTValue max = CGTValue.max(new Number(0), new Infinitesimal(1), true);
        Assert.assertThat(max, CoreMatchers.equalTo(new Number(0)));
    ...
    @Test public void max_Nimber_Infinitesimal() {
    ...
    @Test public void max_Infinitesimal_Nimber() {
    ...
    @Test public void max_Nimber_Switch() {
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void max_Switch_Nimber() {
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void equal_Number_Number() {
    ...
    @Test public void equal_Number_Nimber() {
    ...
    @Test public void equal_Number_Infinitesimal() {
    ...
    @Test public void equal_Nimber_Nimber() {
    ...
    @Test public void equal_Nimber_Infinitesimal() {
    ...
    @Test public void equal_Infinitesimal_Infinitesimal() {
    ...
    @Test public void equal_Number_Switch() {
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void equal_Switch_Switch() {
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void equal_Nimber_Switch() {
        Number first = new Number(2);
        Number second = new Number(-3);
    ...
    @Test public void equal_Infinitesimal_Switch() {
        Number first = new Number(2);
        Number second = new Number(-3);
